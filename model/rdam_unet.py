...
class DWRDAM_UNet(RDAM_UNet):
    def __init__(self, 
        ...
        # 解码器
        self.decoder1 = AMSFNV2(base_channels * 16 ,  base_channels * 4)
        self.decoder2 = AMSFNV2(base_channels * 8,    base_channels * 2)
        self.decoder3 = AMSFNV2(base_channels * 4,    base_channels,   )
        self.decoder4 = AMSFNV2(base_channels * 2,    base_channels,   )
        # 输出层
        self.out_conv = nn.Conv2d(base_channels, n_classes, kernel_size=3, padding=1)
...
class DWRDAM_UNetV2(DWRDAM_UNet):
    def __init__(self, 
        ...
        self.out_conv = nn.Conv2d(base_channels * 4, n_classes,  kernel_size=3, padding=1)
...
if __name__ == "__main__":
    ...
    model1 = DWRDAM_UNetV3(in_channels=3, n_classes=4, p=0)
